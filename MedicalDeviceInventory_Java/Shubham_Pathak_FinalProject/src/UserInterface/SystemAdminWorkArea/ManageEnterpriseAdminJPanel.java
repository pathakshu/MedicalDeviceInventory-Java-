...
//        
//        //{ UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new SupplierRole());}
//              
//          // else if(enterprise.getEnterpriseType().equals(Enterprise.EnterpriseType.Warehouse))
//        
//       // { UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new WarehouseManagerRole());}
//         
        String userName = usernameJTextField.getText();
        ...
        boolean check = enterprise.getUserAccountDirectory().checkIfUsernameIsUnique(userName);
        if(check==false){
            JOptionPane.showMessageDialog(null,"User Name should be unique");
            return;
        }
        
        Employee employee = enterprise.getEmployeeDirectory().createEmployee(enterpriseName);
